...
import ui.top.interactiveformuladialog.InteractiveFormulaDialogController;
...
public class OptionsBarController {
    ...
    private void handleInteractiveFormulaButtonAction() {
        try {
            ...
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/ui/top/interactiveformuladialog/InteractiveFormulaDialog.fxml"));
